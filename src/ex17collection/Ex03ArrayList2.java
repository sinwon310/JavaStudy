...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		/*
		시나리오] 컬렉션에 저장된 객체를 이름으로 검색하여
		삭제할 수 있는 코드를 작성하시오. 이 때 반복문은
		확장 for문을 사용하시오.
		 */
		int idx = 0;
		...
		for(Student st : list2) {
			...
			삭제를 위해 입력한 이름과 Student 인스턴스에 저장된
			name과 일치하는지 확인 한 후 해당 인스턴스를
			검색할 수 있다.
			 */
		...
		인스턴스의 인덱스 통해 삭제하면 참조값이 반환된다. 따라서
