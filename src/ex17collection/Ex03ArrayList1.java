...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		//LinkedList<String> list = new LingkedList(String));
		//VectorList<String> list = new Vector<String>();
		...
		인스턴스저장 : add()
			...
			add(인덱스, 인스턴스) : 데이터 저장시 인덱스를
				...
				발생되므로 주의해야한다. 저장하려는 인덱스에
				이미 저장된 데이터가 있다면 삽입(끼워넣기)
				이 된다.			
		 */
