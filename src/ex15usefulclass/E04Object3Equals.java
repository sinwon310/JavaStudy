...
class MyClass{
	...
	public boolean equals(Object obj) {
		...
		이 때 전달된 인스턴스가 MyClass형이 아니라면 비교의 대상이
		...
		if(obj instanceof MyClass) {
			...
			다운캐스팅한다. 그렇지 않으면 부모타입으로는
			자식멤버에 접근할 수 없으므로 멤버변수에 대한 비교가
			불가능하다.
			 */
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		단, 오버라이딩 해놓은 equals()를 삭제한 후 비교하면
		다르다는 결과가 나오게 된다. 즉 우리가 직접 정의한 클래스라면
		반드시 오버라이딩이 필요하다.
		 */
		...
		/*
		print를 통해 출력하면 자동으로 toString이 호출되므로
		아래의 출력결과는 둘 다 동일하다
		 */
